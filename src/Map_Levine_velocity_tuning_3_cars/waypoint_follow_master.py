...
if __name__ == "__main__":
    ...
    while True:
        ...
        trajectory_3 = rrt_3.find_path()
        
#        trajectory_1 = np.array([[ 2.436737,    0.06004827],
#         [ 2.04181715, -0.12879133],
#         [ 1.75131819, -0.20369363],
#         [ 1.26917206, -0.32511639],
#         [ 0.67077119, -0.28159725],
#         [ 0.37144091, -0.26156267],
#         [-0.22715976, -0.22125232],
#         [-0.81894472, -0.28546962],
#         [-1.11808208, -0.30820372],
#         [-1.70958929, -0.34266773],
#         [-2.28756699, -0.39639968],
#         [-2.88554492, -0.42989402],
#         [-3.48445948, -0.44945206],
#         [-4.08088731, -0.38746476],
#         [-4.48231996, -0.25768619],
#         [-5.        ,  0.        ]])
#        trajectory_2 = np.array([[ 3.48406042, -0.0925569 ],
#         [ 3.187888  , -0.04478766],
#         [ 2.59486761, -0.05554589],
#         [ 1.99881504,  0.01217994],
#         [ 1.48110904, -0.13051615],
#         [ 1.18223541, -0.15648834],
#         [ 0.76929893, -0.00701263],
#         [ 0.17159755, -0.04225204],
#         [-0.12840057, -0.04331352],
#         [-0.63166422, -0.22382458],
#         [-0.94400996, -0.47927256],
#         [-1.53542849, -0.5730801 ],
#         [-1.90905856, -0.38532652],
#         [-2.35888848, -0.23058677],
#         [-2.64506614, -0.14057373],
#         [-3.21165795, -0.08281823],
#         [-3.5       ,  0.        ]]) 
#        trajectory_3 = np.array([[ 5.26278882e+00, -5.64002716e-02],
#         [ 4.68058941e+00,  1.64058122e-02],
#         [ 4.39206667e+00,  4.70579366e-03],
#         [ 3.82162227e+00,  8.61038332e-02],
#         [ 3.22651589e+00,  3.48699665e-02],
#         [ 2.65555002e+00,  4.74096218e-02],
#         [ 2.10261638e+00,  1.98291633e-01],
#         [ 1.55364507e+00,  1.45450721e-02],
#         [ 9.64230327e-01, -5.21766677e-02],
#         [ 3.71710296e-01,  6.99488181e-03],
#         [-2.26722993e-01,  4.79140541e-02],
#         [-8.25901265e-01,  4.33637489e-02],
#         [-1.12568955e+00,  3.20951123e-02],
#         [-1.70046042e+00, -1.66144842e-02],
#         [-2.00000000e+00,  0.00000000e+00]])
        ...
        msg = {
            "goal_pts": [rrt_1.goal_pt, rrt_2.goal_pt, rrt_3.goal_pt],
            "trajectory": [trajectory_1.tolist(), trajectory_2.tolist(), trajectory_3.tolist()],
            "laser_scan_obst": laser_scan_obst,
            "search_area": [rrt_1.search_area, rrt_2.search_area, rrt_3.search_area]
        }

        if len(trajectory_1) > 1 and len(trajectory_2) > 1 and len(trajectory_3) > 1:
            
#            print(trajectory_1, trajectory_2, trajectory_3)
            ...
            smoothedTraj_3 = TrajectorySmoothing(np.flip(trajectory_3, 0), car3_vel)

            # calc max time along path between two smoothed trajectories
            max_time = max(smoothedTraj_3.total_time, max(smoothedTraj_1.total_time, smoothedTraj_2.total_time))*2
            ...
            pathTraj_3 = PathTrajectory(smoothedTraj_3.get_total_path(time_step),
                                        np.array([[0, 0], [smoothedTraj_3.total_time, 1]]), smoothedTraj_3.total_time)

            velocityTuner = VelocityTuner(pathTraj_1, pathTraj_2, pathTraj_3, max_time, time_step, car1_vel, car2_vel, car3_vel)
            velocityTuner.tune_velocities()
            pathTraj_2 = velocityTuner.pathTrajectories[1]
            pathTraj_3 = velocityTuner.pathTrajectories[2]
            pathTrajvelocity_1, pathTrajvelocity_2, pathTrajvelocity_3 = velocityTuner.calculate_trajectory(car1_vel)

            msg["trajectory_velocity"] = [pathTrajvelocity_1.tolist(), pathTrajvelocity_2.tolist(), pathTrajvelocity_3.tolist()]
            msg["trajectory"] = [pathTraj_1.path.tolist(), pathTraj_2.path.tolist(), pathTraj_3.path.tolist()]
